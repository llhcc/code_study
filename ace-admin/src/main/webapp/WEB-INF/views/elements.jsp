		...
		<div class="row">
			<div class="col-xs-12">
							...
							<div class="widget-body">
								<div class="widget-main">
									<p class="muted">
										...
										them. Farm-to-table seitan, mcsweeney's fixie sustainable
										quinoa 8-bit american apparel <a title="Another tooltip"
											data-rel="tooltip" href="#">have a</a> terry richardson vinyl
										chambray. A really ironic artisan <a data-rel="tooltip"
											href="#" data-original-title="Another one here too">whatever</a>
										keytar, scenester farm-to-table banksy Austin <a
											title="The last tip!" data-rel="tooltip" href="#">twitter</a>
										handle.
									</p>
									...
									<p>
										...
										<span class="btn btn-success btn-sm tooltip-success"
											...
											title="Right Success">Right</span> <span
											class="btn btn-danger btn-sm tooltip-error"
				...
				<div class="row">
						...
						<div class="dropdown dropdown-preview">
							<ul class="dropdown-menu dropdown-danger">
								...
								<li class="dropdown-hover"><a href="#" tabindex="-1"
									class="clearfix"> <span class="pull-left">More
											options</span> <i class="icon-caret-right pull-right"></i>
								</a>
					...
					<div class="col-sm-6">
						<h3 class="row header smaller lighter blue">
							<span class="col-sm-7"> <i class="icon-th-large"></i>
								Pills
							</span>
							<!-- /span -->
