...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-header">
			<h1>
				Buttons &amp; Icon <small> <i
					class="icon-double-angle-right"></i> Common Buttons &amp; Icons
				</small>
			</h1>
		</div>
		<!-- /.page-header -->
					...
					<div class="col-sm-6">
						...
						<div>
							...
							<div data-toggle="buttons" class="btn-group">
								...
								<input type="radio" value="1" /> <i
									class="icon-only icon-align-left"></i>
								<button class="btn btn-primary" type="button"></button>

								<input type="radio" value="2" /> <i
									class="icon-only icon-align-center"></i>
								<button class="btn btn-primary" type="button"></button>

								<input type="radio" value="3" /> <i
									class="icon-only icon-align-right"></i>
							</div>
				...
				<div class="row">
					<div class="col-xs-12">
						<h3 class="header smaller lighter blue">
							361 Scalable FontAwesome Icons <small> <a
								href="http://fontawesome.io/icons/" target="_blank"> (see
									all icons <i class="icon-external-link"></i> )
							</a>
							</small>
						</h3>
					</div>
					...
					<div class="col-xs-6 col-sm-3">
						<ul class="list-unstyled">
							...
							<li><i class="icon-bookmark-empty"></i> icon-bookmark-empty
							</li>
					...
					<div class="col-xs-6 col-sm-3">
						<ul class="list-unstyled">
							...
							<li><i class="icon-cloud-download"></i> icon-cloud-download
							</li>
					...
					<div class="col-xs-6 col-sm-3">
						<ul class="list-unstyled">
							...
							<li><i class="icon-facetime-video"></i> icon-facetime-video
							</li>
